    ...
    return (
        <div id="latest-project-content">
            <div style={{flexBasis: "100%"}}>
                <ProjectDescription dlMode={dlMode} latest={true} project={LatestProjectInfo}/>
            </div>
        </div>
    )
}
                ...
                <section>   
                    <div className="width-size fade-in-3" id="project-main"> 
                        <div className="project-main-content">
                            ...
                            <ScrollLink to="latest" spy={true} smooth={true} duration={320}><FontAwesomeIcon className={`scroll-down-icon ${dlMode ? 'white' : 'black'}`}icon={faCaretDown}/></ScrollLink>
                        </div>
                    </div>
                </section>
                <section>
                    <div className={`project-section ${dlMode ? 'bg-white' : 'bg-black'}`}>
                        <div className="fade-in-3 width-size" id="latest">
                            <div style={{paddingTop: "3vh"}}>
                                <hr className={`project-section-line ${dlMode ? 'bg-black' : 'bg-white'}`}></hr>
                                <h1 className={`project-section-title ${dlMode ? 'black' : 'white'}`}>Latest Project</h1>
                                <hr className={`project-section-line ${dlMode ? 'bg-black' : 'bg-white'}`} style={{width: "60%"}}></hr>
                            </div>
                ...
                <section>
                    {
                        this.state.messageIndex !== null ? 
                            <PopUpPrompt onClick={this.triggerPopupOff} project={projectInfo[this.state.messageIndex]} dlMode={dlMode}/>
                            : null
                    }
