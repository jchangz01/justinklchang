          ...
          <div className="width-size fade-in-3" id="home-main">
            <div className="home-main-content">
              <div style={{ marginBottom: "80px" }}>
                <h1
                  className={`home-main-title ${dlMode ? "white" : "black"}`}
                  onClick={() => console.log(dlMode)}
                >
                  Justin Kyle
                </h1>
                ...
                <h3>
                  <a
                    className={`home-main-subsubtitle ${
                      dlMode ? "white" : "black"
                    }`}
                    href="/#about"
                  >
            ...
            <div className="home-main-content">
              <img
                ...
                className={`home-main-pic ${
                  dlMode ? "float-white" : "float-black"
                }`}
              />
              <div
                className={`home-main-circ ${
                  dlMode ? "float-white circ-dark" : "float-black circ-light"
                }`}
              >
                <div
                  className={`home-main-subcirc ${
                    dlMode ? "subcirc-dark" : "subcirc-light"
                  }`}
                ></div>
              </div>
            </div>
        ...
        <footer>
          <div id="footer-info" className={dlMode ? "white" : "black"}>
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://github.com/jchangz01/justinklchang"
