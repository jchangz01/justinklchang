        ...
        <div className="width-size fade-in-3" id="about-main">
          <div className="about-main-content" style={{ textAlign: "right" }}>
            <img
              ...
              src={aboutProfile}
              alt="Did not load, please refresh"
            />
          </div>
          <div className={`about-main-content ${dlMode ? "white" : "black"}`}>
            <div style={{ marginLeft: "40px" }}>
              <h1 className={`about-main-title ${dlMode ? "white" : "black"}`}>
                About Me
              </h1>
              <hr
                className={`about-main-linebreak ${
                  dlMode ? "bg-white" : "bg-black"
                }`}
              ></hr>
              <p
              ...
              <p
                className={`about-main-paragraph ${dlMode ? "white" : "black"}`}
              >
                I love to solve problems, build applications, collaborate in
                teams, and during my free time, go on runs and hikes!
              </p>
              <p
                className={`about-main-paragraph ${dlMode ? "white" : "black"}`}
              >
                Check out my projects{" "}
                <a href="/#projects" className={dlMode ? "white" : "black"}>
                  here
                </a>{" "}
                and/or connect with me{" "}
                <a href="/#contact" className={dlMode ? "white" : "black"}>
                  here
                </a>
                .
              </p>
              <div className="about-main-socials">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.instagram.com/j.changz/"
                >
                  <FontAwesomeIcon
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.linkedin.com/in/justin-kyle-chang-31582419b/"
                >
                  <FontAwesomeIcon
                    className={dlMode ? "white" : "black"}
                    icon={faLinkedin}
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.facebook.com/justin.chang.54772/"
                >
                  <FontAwesomeIcon
                    className={dlMode ? "white" : "black"}
                    icon={faFacebook}
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://github.com/jchangz01"
                >
                  <FontAwesomeIcon
                    className={dlMode ? "white" : "black"}
                    icon={faGithub}
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://open.spotify.com/user/justinklchang?si=f50776d8724a43c5"
                >
                  <FontAwesomeIcon
                    className={dlMode ? "white" : "black"}
                    icon={faSpotify}
                ...
                <a
                  target="_blank"
                  rel="noreferrer"
                  href="https://www.strava.com/athletes/51901493"
                >
                  <FontAwesomeIcon
                    className={dlMode ? "white" : "black"}
                    icon={faStrava}
