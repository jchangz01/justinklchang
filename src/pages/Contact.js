      ...
      <div>
        <a
          ...
          className={`icon-circle instagram ${
            dlMode ? "float-white bg-black" : "float-black bg-white"
          }`}
        >
          <FontAwesomeIcon
            className={`icon ${dlMode ? "white" : "black"}`}
            icon={faInstagram}
          />
        </a>
...
export default class Contact extends React.Component {
  ...
  copyToClipboard = (type) => {
    var text =
      type === "personal" ? "justinklchang@yahoo.com" : "jchangz01@g.ucla.edu";
      ...
      <section>
        <div className="width-size fade-in-3" id="contact-main">
          <div className="contact-main-content">
            <h1 id="contact-main-title" className={dlMode ? "white" : "black"}>
              Contact Me
            </h1>
            ...
            {this.state.message ? (
              <div
                ...
                className="contact-message fade-in-2"
              >
                Copied to Clipboard
              </div>
            ) : null}
